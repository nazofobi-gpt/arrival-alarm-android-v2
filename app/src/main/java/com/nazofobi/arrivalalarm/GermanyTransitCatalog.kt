...
object GermanyTransitFixtures {
    val snapshot=CatalogSnapshot(
        ...
        trips=listOf(CatalogTrip("t-hb-6-1200","delfi","r-hb-6","12:00"),CatalogTrip("t-be-s5-1205","vbb","r-be-s5","12:05"),CatalogTrip("t-by-s8-1210","mvv","r-by-s8","12:10")),generatedAt="2026-09-22T17:49:34+02:00")
}
