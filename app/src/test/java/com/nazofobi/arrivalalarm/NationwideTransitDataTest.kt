...
class NationwideTransitDataTest {
    ...
    @Test fun journeyParserCarriesRealStopoversTripIdsAndRefreshToken() {
        val json = JSONObject(
            """{"journeys":[{"refreshToken":"refresh-1","legs":[
              {"departure":"2026-09-26T08:00:00+02:00","arrival":"2026-09-26T08:45:00+02:00",
        ...
        val option = GermanyLiveTransitApi().parseJourneys(
            json,
